Чтобы правильно запустить проэкт нужно:
1. Скачать его с github
2. Открыть консоль и поменять директорию на *путь к проэкту*\target. Пример для Windows:
cd C:\Users\Юра\Documents\Java\LeoGaming\target
3. Запустить исполняемый jar и в качестве параметров передать param1 - путь к проэкту, param2 - файл который нужно 
